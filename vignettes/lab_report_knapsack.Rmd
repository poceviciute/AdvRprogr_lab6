...
```{r data, warning = FALSE, comment= NA, message=FALSE, eval = FALSE}
library(dplyr)
library(parallel)
...
```{r, brute_force, echo = FALSE, eval = FALSE}
...
```{r, greedy_knapsack, echo = FALSE, eval = FALSE}
